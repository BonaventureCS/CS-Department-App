...
//			});	
	  ...
	  public static final class VideoListFragment extends ListFragment {
	    ...
	    static {
	      ...
	      list.add(new VideoEntry("CS at Bonaventure", "oxYZ5_u6Z7A"));
	      list.add(new VideoEntry("2013 Orientation", "kKHjkK_CUi0"));
	      list.add(new VideoEntry("Bonaventure Today", "ihe2YXLUOvk"));
	      list.add(new VideoEntry("What's a Bonnie?", "33P4thwnFjw"));
